...
public class BonusSprite extends AnimatedSprite {
    ...
    public void someThingElse(){
        Tween.to(tweenData, TweenDataAccessor.TYPE_POS,10f)
                .target(Constants.SCENE_WIDTH, Constants.SCENE_HEIGHT/2).start(tweenManager);//to(tweenData, TweenDataAccessor.TYPE_POS,250f);
    }
}
